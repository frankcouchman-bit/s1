  ...
  return (<div className="min-h-screen bg-white">
    ...
    <section className="pt-20 pb-8"><div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <h1 className="text-5xl md:text-6xl font-black leading-tight text-slate-900">AI Writer for {region.name}</h1>
        <RegionPicker onChange={setRegion} /></div>
      <p className="mt-4 text-slate-600 text-lg">AI writer with real-time SERP research. Create SEO-optimized articles, citations, images, and meta tags in under a minute.</p>
